# PowerShell script to replace mobile headers in all HTML files
$ErrorActionPreference = "Stop"

# The new mobile header HTML (from index.html with "پژو 206")
$newMobileHeader = @'
<header class="site__mobile-header">
			...
			<div class="mobile-header">
				...
				<div class="container">
					...
					<div class="mobile-header__body"><button class="mobile-header__menu-button" type="button"><svg width="18px" height="14px">
							...
							</svg></button> <a class="mobile-header__logo" href="index.html"><img src="images/sttechLogo.png" alt="Logo" style="max-height: 40px;">
	...
	c-2.8,0-5.5-1.7-6.4-4C116.7,15.1,117.4,14,118.4,14z">
						...
						<div class="mobile-header__search mobile-search">
							...
							<form class="mobile-search__body"><input type="text" class="mobile-search__input" placeholder="نام قطعه،شماره سریال .."> <button type="button" class="mobile-search__vehicle-picker" aria-label="انتخاب وسیله نقلیه"><svg width="20" height="20">
	...
	C15.5,10.2,14,11.3,14,12z"></path>
									...
									</svg> <span class="mobile-search__vehicle-picker-label">پژو 206</span></button> <button type="submit" class="mobile-search__button mobile-search__button--search"><svg width="20" height="20">
	...
	c0,2.8,2.2,5,5,5c2.8,0,5-2.2,5-5C13,5.2,10.8,3,8,3z"></path>
							...
							<div class="mobile-indicator d-none d-md-block"><a href="account-login.html" class="mobile-indicator__button"><span class="mobile-indicator__icon"><svg width="20" height="20">
	...
	c0,1.9-0.9,3.6-2.3,4.7C17.4,12.2,20,15.8,20,20z M14,6c0-2.2-1.8-4-4-4S6,3.8,6,6s1.8,4,4,4S14,8.2,14,6z"></path>
							...
							<div class="mobile-indicator d-none d-md-block"><a href="wishlist.html" class="mobile-indicator__button"><span class="mobile-indicator__icon"><svg width="20" height="20">
	...
	c-1.5,0-2.9,0.6-4,1.5C8.9,1.6,7.5,1,6,1C2.7,1,0,3.7,0,7c0,5,6,12,10,12s10-7,10-12C20,3.7,17.3,1,14,1L14,1z"></path>
							...
							<div class="mobile-indicator"><a href="cart.html" class="mobile-indicator__button"><span class="mobile-indicator__icon"><svg width="20" height="20">
	...
	C17.9,5.2,17.7,5,17.5,5H9.4C9.2,5,9,4.8,9,4.6V3.4C9,3.2,9.2,3,9.4,3h9.2C19.4,3,20,3.6,20,4.4z"></path>
									...
									</svg> <span class="mobile-indicator__counter" style="display: none;">0</span></span></a></div>

							<div class="mobile-indicator"><a href="BranchPortal.html" class="mobile-indicator__button"><span class="mobile-indicator__icon"><svg width="20" height="20" viewBox="0 0 20 20">

											<!-- Three figures at top - larger -->

											<circle cx="3.5" cy="2.5" r="1.8" fill="currentColor"></circle>

											<path d="M2,5 L2,8 L5,8 L5,5 Z" fill="currentColor"></path>

											<circle cx="10" cy="2.5" r="1.8" fill="currentColor"></circle>

											<path d="M8.5,5 L8.5,8 L11.5,8 L11.5,5 Z" fill="currentColor"></path>

											<circle cx="16.5" cy="2.5" r="1.8" fill="currentColor"></circle>

											<path d="M15,5 L15,8 L18,8 L18,5 Z" fill="currentColor"></path>

											<!-- Vertical line from center figure -->

											<line x1="10" y1="8" x2="10" y2="11" stroke="currentColor" stroke-width="2" stroke-linecap="round"></line>

											<!-- Horizontal branch -->

											<line x1="2" y1="11" x2="18" y2="11" stroke="currentColor" stroke-width="2" stroke-linecap="round"></line>

											<!-- Three boxes below - larger -->

											<rect x="1.5" y="13" width="4" height="4" stroke="currentColor" stroke-width="1.5" fill="currentColor"></rect>

											<rect x="8" y="13" width="4" height="4" stroke="currentColor" stroke-width="1.5" fill="currentColor"></rect>

											<rect x="14.5" y="13" width="4" height="4" stroke="currentColor" stroke-width="1.5" fill="currentColor"></rect>

										</svg></span></a></div>

							<div class="mobile-indicator"><a href="account-guaranty.html" class="mobile-indicator__button"><span class="mobile-indicator__icon"><svg width="20" height="20">

											<path d="M10,0L2,4v6c0,5.5,3.8,10.7,8,12c4.2-1.3,8-6.5,8-12V4L10,0z M10,2.2L16,5.3v4.7c0,4.6-3.1,9-6,10.1c-2.9-1.1-6-5.5-6-10.1V5.3L10,2.2z"></path>

											<path d="M10,6c-1.1,0-2,0.9-2,2v2c0,1.1,0.9,2,2,2s2-0.9,2-2V8C12,6.9,11.1,6,10,6z M10,10c-0.6,0-1-0.4-1-1V8c0-0.6,0.4-1,1-1s1,0.4,1,1v1C11,9.6,10.6,10,10,10z"></path>
...
# Get all HTML files, excluding header variant files
$htmlFiles = Get-ChildItem -Path . -Filter "*.html" | Where-Object { 
    $_.Name -notlike "header-*" -and $_.Name -notlike "mobile-header-variant-*"
}

Write-Host "Found $($htmlFiles.Count) HTML files to process" -ForegroundColor Cyan
Write-Host "Processing files...`n" -ForegroundColor Yellow
...
foreach ($file in $htmlFiles) {
    try {
        ...
        # Pattern to match mobile header section (from opening tag to closing tag with comment)
        $pattern = '(?s)<header\s+class="site__mobile-header">.*?</header>\s*<!--\s*site__mobile-header\s*/?\s*end\s*-->'
        
        if ($content -match $pattern) {
            $newSection = $newMobileHeader + "<!-- site__mobile-header / end -->"
            $content = $content -replace $pattern, $newSection
            
            # Save with UTF-8 encoding
            [System.IO.File]::WriteAllText($file.FullName, $content, [System.Text.Encoding]::UTF8)
            
            Write-Host "✓ Replaced mobile header in $($file.Name)" -ForegroundColor Green
            $replacedCount++
        } else {
            Write-Host "✗ No mobile header found in $($file.Name)" -ForegroundColor Red
            $skippedCount++
        }
    } catch {
...
Write-Host "Completed! Replaced mobile headers in $replacedCount files." -ForegroundColor Green
