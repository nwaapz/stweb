...
<head>
    ...
    <style>
        ...
        .stat-card.bg-categories { background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); }
        .stat-card.bg-discounts { background: linear-gradient(135deg, #e74c3c 0%, #c0392b 100%); }
        .stat-card.bg-views { background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); }
        .stat-card h3 {
            font-size: 2.5rem;
            margin: 0;
        }
        ...
        <div class="top-navbar">
            ...
            <div class="dropdown user-dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-start">
                    ...
                    <li><a class="dropdown-item text-danger" href="logout.php"><i class="bi bi-box-arrow-right"></i> خروج</a></li>
                </ul>
            </div>
        </div>
