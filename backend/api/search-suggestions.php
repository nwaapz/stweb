...
try {
    ...
    foreach ($products as &$product) {
        ...
        if (!empty($product['slug'])) {
            $product['url'] = 'product-full.html?product=' . urlencode($product['slug']);
        } else {
    ...
    foreach ($categories as &$category) {
        ...
        if (!empty($category['slug'])) {
            $category['url'] = 'category-4-columns-sidebar.html?category=' . urlencode($category['slug']);
        } else {
            $category['url'] = 'category-4-columns-sidebar.html?category=' . $category['id'];
        }
    }
